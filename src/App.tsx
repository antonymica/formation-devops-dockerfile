...
function App() {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-2/3 flex-col gap-4 my-5 bg-base-300 p-5 rounded-2xl">
        ...
        <div className="space-y-2 flex-1 h-fit pt-2.5">
          ...
          {filteredTodos.length > 0 ? (
            ...
            <div className="flex justify-center items-center flex-col p-5">
              <div>
                <Construction className="w-30 h-30 text-primary" />
              </div>
